var t=Object.defineProperty,e=Object.defineProperties,n=Object.getOwnPropertyDescriptors,r=Object.getOwnPropertySymbols,s=Object.prototype.hasOwnProperty,i=Object.prototype.propertyIsEnumerable,o=(e,n,r)=>n in e?t(e,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[n]=r,a=(t,e)=>{for(var n in e||(e={}))s.call(e,n)&&o(t,n,e[n]);if(r)for(var n of r(e))i.call(e,n)&&o(t,n,e[n]);return t},u=(t,r)=>e(t,n(r)),c=(t,e,n)=>new Promise((r,s)=>{var i=t=>{try{a(n.next(t))}catch(e){s(e)}},o=t=>{try{a(n.throw(t))}catch(e){s(e)}},a=t=>t.done?r(t.value):Promise.resolve(t.value).then(i,o);a((n=n.apply(t,e)).next())});import{g as h,a as l,_ as d,b as f,F as g,i as m,p,u as y,d as v,c as w,L as T,e as E,f as _,h as b,S,j as I,C,r as A,k as N}from"./firebase-auth-DogJ4AYO.js";var D,k,R="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{};
/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const le="server_timestamp",de="__type__",fe="__previous_value__",ge="__local_write_time__";function me(t){var e,n;return(null==(n=((null==(e=null==t?void 0:t.mapValue)?void 0:e.fields)||{})[de])?void 0:n.stringValue)===le}function pe(t){const e=t.mapValue.fields[fe];return me(e)?pe(e):e}function ye(t){const e=ue(t.mapValue.fields[ge].timestampValue);return new Vt(e.seconds,e.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}const hi="RestConnection",li={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class di{get $o(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Uo=e+"://"+t.host,this.Ko=`projects/${n}/databases/${r}`,this.Wo=this.databaseId.database===we?`project_id=${n}`:`project_id=${n}&database_id=${r}`}Go(t,e,n,r,s){const i=ci(),o=this.zo(t,e.toUriEncodedString());Q(hi,`Sending RPC '${t}' ${i}:`,o,n);const a={"google-cloud-resource-prefix":this.Ko,"x-goog-request-params":this.Wo};this.jo(a,r,s);const{host:u}=new URL(o),c=m(u);return this.Jo(t,o,a,n,c).then(e=>(Q(hi,`Received RPC '${t}' ${i}: `,e),e),e=>{throw X(hi,`RPC '${t}' ${i} failed with error: `,e,"url: ",o,"request:",n),e})}Ho(t,e,n,r,s,i){return this.Go(t,e,n,r,s)}jo(t,e,n){t["X-Goog-Api-Client"]="gl-js/ fire/"+$,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((e,n)=>t[n]=e),n&&n.headers.forEach((e,n)=>t[n]=e)}zo(t,e){const n=li[t];return`${this.Uo}/v1/${e}:${n}`}terminate(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ha{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new ha(this.firestore,t,this._query)}}class la{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new da(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new la(this.firestore,t,this._key)}toJSON(){return{type:la._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,n){if(Ot(e,la._jsonSchema))return new la(t,n||null,new It(_t.fromString(e.referencePath)))}}la._jsonSchemaVersion="firestore/documentReference/1.0",la._jsonSchema={type:xt("string",la._jsonSchemaVersion),referencePath:xt("string")};class da extends ha{constructor(t,e,n){super(t,e,vn(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new la(this.firestore,null,new It(t))}withConverter(t){return new da(this.firestore,t,this._path)}}function fa(t,e,...n){if(t=h(t),Ct("collection","path",e),t instanceof ca){const r=_t.fromString(e,...n);return Nt(r),new da(t,null,r)}{if(!(t instanceof la||t instanceof da))throw new nt(et.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(_t.fromString(e,...n));return Nt(r),new da(t.firestore,null,r)}}function ga(t,e,...n){if(t=h(t),1===arguments.length&&(e=ft.newId()),Ct("doc","path",e),t instanceof ca){const r=_t.fromString(e,...n);return At(r),new la(t,null,new It(r))}{if(!(t instanceof la||t instanceof da))throw new nt(et.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(_t.fromString(e,...n));return At(r),new la(t.firestore,t instanceof da?t.converter:null,new It(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function cu(t,e,n){let r;return r=t?n&&(n.merge||n.mergeFields)?t.toFirestore(e,n):t.toFirestore(e):e,r}class hu{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}}class lu extends Ga{constructor(t,e,n,r,s,i){super(t,e,n,r,i),this._firestore=t,this._firestoreImpl=t,this.metadata=s}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){const e=new du(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){const n=this._document.data.field(Qa("DocumentSnapshot.get",t));if(null!==n)return this._userDataWriter.convertValue(n,e.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new nt(et.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t=this._document,e={};return e.type=lu._jsonSchemaVersion,e.bundle="",e.bundleSource="DocumentSnapshot",e.bundleName=this._key.toString(),t&&t.isValidDocument()&&t.isFoundDocument()?(this._userDataWriter.convertObjectMap(t.data.value.mapValue.fields,"previous"),e.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),e):e}}lu._jsonSchemaVersion="firestore/documentSnapshot/1.0",lu._jsonSchema={type:xt("string",lu._jsonSchemaVersion),bundleSource:xt("string","DocumentSnapshot"),bundleName:xt("string"),bundle:xt("string")};class du extends lu{data(t={}){return super.data(t)}}class fu{constructor(t,e,n,r){this._firestore=t,this._userDataWriter=e,this._snapshot=r,this.metadata=new hu(r.hasPendingWrites,r.fromCache),this.query=n}get docs(){const t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return 0===this.size}forEach(t,e){this._snapshot.docs.forEach(n=>{t.call(e,new du(this._firestore,this._userDataWriter,n.key,n,new hu(this._snapshot.mutatedKeys.has(n.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){const e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new nt(et.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(t,e){if(t._snapshot.oldDocs.isEmpty()){let e=0;return t._snapshot.docChanges.map(n=>{const r=new du(t._firestore,t._userDataWriter,n.doc.key,n.doc,new hu(t._snapshot.mutatedKeys.has(n.doc.key),t._snapshot.fromCache),t.query.converter);return n.doc,{type:"added",doc:r,oldIndex:-1,newIndex:e++}})}{let n=t._snapshot.oldDocs;return t._snapshot.docChanges.filter(t=>e||3!==t.type).map(e=>{const r=new du(t._firestore,t._userDataWriter,e.doc.key,e.doc,new hu(t._snapshot.mutatedKeys.has(e.doc.key),t._snapshot.fromCache),t.query.converter);let s=-1,i=-1;return 0!==e.type&&(s=n.indexOf(e.doc.key),n=n.delete(e.doc.key)),1!==e.type&&(n=n.add(e.doc),i=n.indexOf(e.doc.key)),{type:gu(e.type),doc:r,oldIndex:s,newIndex:i}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new nt(et.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");const t={};t.type=fu._jsonSchemaVersion,t.bundleSource="QuerySnapshot",t.bundleName=ft.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;const e=[],n=[],r=[];return this.docs.forEach(t=>{null!==t._document&&(e.push(t._document),n.push(this._userDataWriter.convertObjectMap(t._document.data.value.mapValue.fields,"previous")),r.push(t.ref.path))}),t.bundle=(this._firestore,this.query._query,t.bundleName,"NOT SUPPORTED"),t}}function gu(t){switch(t){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return W(61501,{type:t})}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mu(t){t=Rt(t,la);const e=Rt(t.firestore,wa);return function(t,e,n={}){const r=new rt;return t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return function(t,e,n,r,s){const i=new Wo({next:a=>{i.Nu(),e.enqueueAndForget(()=>lo(t,o));const u=a.docs.has(n);!u&&a.fromCache?s.reject(new nt(et.UNAVAILABLE,"Failed to get document because the client is offline.")):u&&a.fromCache&&r&&"server"===r.source?s.reject(new nt(et.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):s.resolve(a)},error:t=>s.reject(t)}),o=new vo(vn(n.path),i,{includeMetadataChanges:!0,qa:!0});return ho(t,o)}(yield ra(t),t.asyncQueue,e,n,r)})),r.promise}(Ea(e),t._key).then(n=>Su(e,t,n))}fu._jsonSchemaVersion="firestore/querySnapshot/1.0",fu._jsonSchema={type:xt("string",fu._jsonSchemaVersion),bundleSource:xt("string","QuerySnapshot"),bundleName:xt("string"),bundle:xt("string")};class pu extends uu{constructor(t){super(),this.firestore=t}convertBytes(t){return new _a(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new la(this.firestore,null,e)}}function yu(t){t=Rt(t,ha);const e=Rt(t.firestore,wa),n=Ea(e),r=new pu(e);return Ha(t._query),function(t,e,n={}){const r=new rt;return t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return function(t,e,n,r,s){const i=new Wo({next:n=>{i.Nu(),e.enqueueAndForget(()=>lo(t,o)),n.fromCache&&"server"===r.source?s.reject(new nt(et.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):s.resolve(n)},error:t=>s.reject(t)}),o=new vo(n,i,{includeMetadataChanges:!0,qa:!0});return ho(t,o)}(yield ra(t),t.asyncQueue,e,n,r)})),r.promise}(n,t._query).then(n=>new fu(e,r,t,n))}function vu(t,e,n){t=Rt(t,la);const r=Rt(t.firestore,wa),s=cu(t.converter,e,n);return bu(r,[Ma(Oa(r),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,ir.none())])}function wu(t,e,n,...r){t=Rt(t,la);const s=Rt(t.firestore,wa),i=Oa(s);let o;return o="string"==typeof(e=h(e))||e instanceof ba?function(t,e,n,r,s,i){const o=t.Cc(1,e,n),a=[qa(e,r,n)],u=[s];if(i.length%2!=0)throw new nt(et.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let h=0;h<i.length;h+=2)a.push(qa(e,i[h])),u.push(i[h+1]);const c=[],l=je.empty();for(let f=a.length-1;f>=0;--f)if(!$a(c,a[f])){const t=a[f];let e=u[f];e=h(e);const n=o.yc(t);if(e instanceof La)c.push(t);else{const r=Va(e,n);null!=r&&(c.push(t),l.set(t,r))}}const d=new se(c);return new Da(l,d,o.fieldTransforms)}(i,"updateDoc",t._key,e,n,r):function(t,e,n,r){const s=t.Cc(1,e,n);Ua("Data must be an object, but it was:",s,r);const i=[],o=je.empty();Wt(r,(t,r)=>{const a=Ba(e,t,n);r=h(r);const u=s.yc(a);if(r instanceof La)i.push(a);else{const t=Va(r,u);null!=t&&(i.push(a),o.set(a,t))}});const a=new se(i);return new Da(o,a,s.fieldTransforms)}(i,"updateDoc",t._key,e),bu(s,[o.toMutation(t._key,ir.exists(!0))])}function Tu(t){return bu(Rt(t.firestore,wa),[new vr(t._key,ir.none())])}function Eu(t,e){const n=Rt(t.firestore,wa),r=ga(t),s=cu(t.converter,e);return bu(n,[Ma(Oa(t.firestore),"addDoc",r._key,s,null!==t.converter,{}).toMutation(r._key,ir.exists(!1))]).then(()=>r)}function _u(t,...e){var n,r,s;t=h(t);let i={includeMetadataChanges:!1,source:"default"},o=0;"object"!=typeof e[o]||va(e[o])||(i=e[o++]);const a={includeMetadataChanges:i.includeMetadataChanges,source:i.source};if(va(e[o])){const t=e[o];e[o]=null==(n=t.next)?void 0:n.bind(t),e[o+1]=null==(r=t.error)?void 0:r.bind(t),e[o+2]=null==(s=t.complete)?void 0:s.bind(t)}let u,l,d;if(t instanceof la)l=Rt(t.firestore,wa),d=vn(t._key.path),u={next:n=>{e[o]&&e[o](Su(l,t,n))},error:e[o+1],complete:e[o+2]};else{const n=Rt(t,ha);l=Rt(n.firestore,wa),d=n._query;const r=new pu(l);u={next:t=>{e[o]&&e[o](new fu(l,r,n,t))},error:e[o+1],complete:e[o+2]},Ha(t._query)}return function(t,e,n,r){const s=new Wo(r),i=new vo(e,s,n);return t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return ho(yield ra(t),i)})),()=>{s.Nu(),t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return lo(yield ra(t),i)}))}}(Ea(l),d,a,u)}function bu(t,e){return function(t,e){const n=new rt;return t.asyncQueue.enqueueAndForget(()=>c(this,null,function*(){return Ro(yield function(t){return na(t).then(t=>t.syncEngine)}(t),e,n)})),n.promise}(Ea(t),e)}function Su(t,e,n){const r=n.docs.get(e._key),s=new pu(t);return new lu(t,s,e._key,r,new hu(n.hasPendingWrites,n.fromCache),e.converter)}!function(t,e=!0){$=S,I(new C("firestore",(t,{instanceIdentifier:n,options:r})=>{const s=t.getProvider("app").getImmediate(),i=new wa(new at(t.getProvider("auth-internal")),new lt(s,t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new nt(et.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Te(t.options.projectId,e)}(s,n),s);return r=a({useFetchStreams:e},r),i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),A(j,B,t),A(j,B,"esm2020")}();export{_u as a,Eu as b,fa as c,ga as d,mu as e,Ta as f,yu as g,Tu as h,su as l,nu as o,Wa as q,vu as s,wu as u,Za as w};
